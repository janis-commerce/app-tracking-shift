...
class Shift {
	...
	async openWorkLog(workLog = {}) {
		try {
			...
			const mustCloseLastWorkLog = this._isNeccesaryCloseLastWorkLog(workLog);
	...
	_isNeccesaryCloseLastWorkLog(newWorkLog) {
		...
		return newWorkLog.referenceId !== lastWorkLog.referenceId;
	}
}
