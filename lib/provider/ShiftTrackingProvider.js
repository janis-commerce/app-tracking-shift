...
import {openShift, downloadWorkLogTypes, getShiftWorkLogsFromJanis} from '../helpers/provider';
import {
...
const ShiftTrackingProvider = ({children, additionalInfo = {}, onError = null}) => {
	...
	const {hasStaffAuthorization = false, inactivityTimeout = 0} = globalSettings?.settings || {};
