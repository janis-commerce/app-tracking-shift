...
export const STAFF_GLOBAL_SETTINGS = 'staff.globalSettings';
export const LAST_TIMER_RESET_AT = 'shift.lastTimerResetAt';

// EXPIRATION TIMES
export const WORKLOG_TYPES_EXPIRATION_TIME = 4 * 60 * 60 * 1000; // 4 hours
export const GLOBAL_SETTINGS_EXPIRATION_TIME = 24 * 60 * 60 * 1000; // 24 hour
